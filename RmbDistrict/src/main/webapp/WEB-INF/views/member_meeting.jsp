...
<label> Meeting with <span class="red">*</span> </label>
...
<span class="text">  Add Meeting </span>
 ...
 -->
 <button class="btn btn-primary" ng-click="saveOnetoOne(<%= session.getAttribute("loginid") %>)" style="background-color:  #005daa;    width: 100%;"><i class="fa fa-refresh fa-spin" ng-show="spin == 1"></i> Save</button>
</div>
</div>
</div>
