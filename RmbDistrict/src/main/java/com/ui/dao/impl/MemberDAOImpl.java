...
public class MemberDAOImpl implements MemberDAO {
  ...
  public Members checkCurrentPassword(int memberid, String password) {
	...
	@Override
	public Members getFellowshipForMail(int fellowship_id) {
		 logger.info("+++++ getFellowshipForMail +++++");
		 String s="y";
	      String sql = "select * from chapter where fellowship_id=? and status=?";
	      ...
	      try {
	          ...
	          if (rs.next()) {
	              m = new Members();
		           ...
		           System.out.println("email==========="+rs.getString("chapter_username"));
		           System.out.println("email==========="+rs.getString("chapter_password"));
